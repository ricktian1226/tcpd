// xypanic
// 提供了goroutine panic时打印堆栈信息的注册函数
package xypanic
...
//panic开关
var gPanicSwitch = true

func SetPanicSwitch(panicSwitch bool) {
	gPanicSwitch = panicSwitch
}
...
func Crash(path, id string) {
	...
	if err := recover(); err != nil {
		file := fmt.Sprintf("%s/Crash.%d.log", path, id)
